      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            // use the previous path's end point as atarting reference
            else
            {
              ...
              //Use two points that make the path tangent to the previous path'send point
            ...
            {
              //shift for reference angle to 0 degree
